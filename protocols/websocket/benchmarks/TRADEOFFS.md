...
- `protocols/websocket/protocols/websocket/benchmarks/REPORT.md`
- `protocols/websocket/protocols/websocket/benchmarks/results/*.json`
...
Use both `protocols/websocket/protocols/websocket/benchmarks/REPORT.md` and this file together when deciding architecture.
