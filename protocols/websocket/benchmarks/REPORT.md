...
```bash
python protocols/websocket/protocols/websocket/benchmarks/run_benchmark.py --base-url http://127.0.0.1:8000 --clients 10 --messages 40 --payload-size 64 --transport both --output protocols/websocket/protocols/websocket/benchmarks/results/c10_p64.json
python protocols/websocket/protocols/websocket/benchmarks/run_benchmark.py --base-url http://127.0.0.1:8000 --clients 10 --messages 40 --payload-size 1024 --transport both --output protocols/websocket/protocols/websocket/benchmarks/results/c10_p1024.json
python protocols/websocket/protocols/websocket/benchmarks/run_benchmark.py --base-url http://127.0.0.1:8000 --clients 50 --messages 20 --payload-size 64 --transport both --output protocols/websocket/protocols/websocket/benchmarks/results/c50_p64.json
python protocols/websocket/protocols/websocket/benchmarks/run_benchmark.py --base-url http://127.0.0.1:8000 --clients 50 --messages 20 --payload-size 1024 --transport both --output protocols/websocket/protocols/websocket/benchmarks/results/c50_p1024.json
```
...
- Add CPU and memory capture to align with `protocols/websocket/protocols/websocket/benchmarks/PLAN.md`.
