...
- Persist raw run outputs as CSV/JSON under `benchmarks/results/`.

## 7) Suggested Output Artifacts

- `benchmarks/results/*.csv` raw measurements
- `benchmarks/results/*.json` metadata and summary stats
- `benchmarks/plots/*.png` generated charts
- `benchmarks/REPORT.md` benchmark findings + interpretation
